...
class Register:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"College img\bgReg.jpg")
       ...
       # loginbtn=Button(frame,text="Login",command=self.Close,font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="#fff",bg="#002B53",activeforeground="white",activebackground="#007ACC")
        #loginbtn.place(x=533,y=510,width=270,height=35)
