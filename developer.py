...
# This part is image labels setting start 
        ...
        # backgorund image 
        bg1=Image.open(r"College img\d.jpg")
        ...
        #title section
        title_lb1 = Label(bg_img,text="Developer Pannel",font=("verdana",30,"bold"),bg="blue",fg="white")
        title_lb1.place(x=0,y=0,width=1366,height=45)

        # Create buttons below the section 
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"College img\Shivam.jpg")
        ...
        std_b1_1 = Button(bg_img,text="Shivam Dubey",cursor="hand2",font=("tahoma",15,"bold"),bg="black",fg="white")
        std_b1_1.place(x=250,y=380,width=180,height=45)

        # Detect Face  button 2
        det_img_btn=Image.open(r"College img\Nikhil.jpg")
        ...
        det_b1_1 = Button(bg_img,text="Nikhil Kaushik",cursor="hand2",font=("tahoma",15,"bold"),bg="black",fg="white")
        det_b1_1.place(x=480,y=380,width=180,height=45)

         # Attendance System  button 3
        att_img_btn=Image.open(r"College img\Satyam.jpg")
        ...
        att_b1_1 = Button(bg_img,text="Satyam",cursor="hand2",font=("tahoma",15,"bold"),bg="black",fg="white")
        att_b1_1.place(x=710,y=380,width=180,height=45)

         # Help  Support  button 4
        hlp_img_btn=Image.open(r"College img\sittu.jpg")
        ...
        hlp_b1_1 = Button(bg_img,text="S.K.Gond",cursor="hand2",font=("tahoma",15,"bold"),bg="black",fg="white")
